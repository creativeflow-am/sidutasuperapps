...
const App: React.FC = () => {
  ...
  const handleLogin = (password: string) => {
    // PASSWORD AKSES: Silakan ubah angka di bawah ini untuk mengganti password manual
    const correctPassword = '12344321';
        ...
        <header className="top-bar">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            <button
              ...
              className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl border border-[var(--g-border)] flex items-center justify-center transition-all hover:bg-red-500/10 text-red-500"
              title="Logout"
            >
            ...
            <button
              ...
              className={`w-8 h-8 sm:w-10 sm:h-10 rounded-xl border flex items-center justify-center transition-all duration-500 ${theme === 'dark'
                ...
                <div className="flex gap-2 p-1 bg-[var(--g-surface-variant)] rounded-2xl w-fit border border-[var(--g-border)]">
                  {['Active', 'Completed', 'All'].map((f) => (
                    <button
                      ...
                      className={`px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${scheduleFilter === f
